<?php
/**
 * 自己完結コンテンツインポーター（デプロイ可能・一時用）。
 * 同階層の content.seed.json を読み、slug 基準で冪等に投入/更新する。
 * 実行: wp eval-file /srv/htdocs/wp-content/kcc-seed/import.php
...
$seed_path = __DIR__ . '/content.seed.json';
